...
`FundsTransferRequestGroup.EncryptedBankAccountInfo` is configured as an owned value object. The composite request-group index uses owned-property shadow names alongside account-holder and effective-date fields.
